...
sendVarToJS('eqType', 'transfer');
$eqLogics = eqLogic::byType('transfer');
?>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo "<center>";
	echo '<img src="plugins/transfer/doc/images/transfer_icon.png" height="105" width="95" />';
	echo "</center>";
...
<?php include_file('desktop', 'transfer', 'js', 'transfer');?>
